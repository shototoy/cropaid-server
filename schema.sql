...
CREATE TABLE IF NOT EXISTS farmers (
    ...
    address_sitio VARCHAR(100),
    address_barangay VARCHAR(100),
    address_municipality VARCHAR(100) DEFAULT 'Norala',
    address_province VARCHAR(100) DEFAULT 'South Cotabato',
...
CREATE TABLE IF NOT EXISTS farms (
    ...
    location_sitio VARCHAR(100),
    location_barangay VARCHAR(100),
    location_municipality VARCHAR(100) DEFAULT 'Norala',
    location_province VARCHAR(100) DEFAULT 'South Cotabato',
    latitude DECIMAL(10, 8),
    longitude DECIMAL(11, 8),
    farm_size_hectares DECIMAL(10, 2),
    ownership_type ENUM('Owned', 'Leased', 'Tenant') DEFAULT 'Owned',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
